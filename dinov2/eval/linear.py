...
class LinearClassifier(nn.Module):
    ...
    def __init__(self, out_dim, use_n_blocks, use_avgpool, num_classes=1):
        super().__init__()
...
def setup_linear_classifiers(sample_output, n_last_blocks_list, learning_rates, batch_size, num_classes=1):
